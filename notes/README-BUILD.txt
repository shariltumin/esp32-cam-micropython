...
- Copy all files needed which will build micropython with camera module
- assumming these files are under ~/Downloads/esp32-cam
...
- Nice, we did it, celebrate have a cup of coffe with cream and read my blog.
